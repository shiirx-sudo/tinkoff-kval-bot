...
COLUMNS = [
    ...
    "fundamental_score", "fundamental_verdict", "management_alignment",
...
def _row(sig: Signal, strategy: str, ts: str) -> dict:
    return {
        ...
        "fundamental_score": _s(sig.fundamental_score),
        "fundamental_verdict": sig.fundamental_verdict,
        "management_alignment": sig.management_alignment,
        "cash_return": sig.cash_return, "state_role": sig.state_role,
        "market_growth": sig.market_growth,
        "fundamental_reasons": " | ".join(sig.fundamental_reasons),
        "score": sig.score,
